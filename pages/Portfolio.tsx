...
const projects: Project[] = [
  { id: 1, title: "Martial Art Demo Website", category: "Website", image: "https://images.unsplash.com/photo-1555597673-b21d5c935865?w=800", url: "https://taekwondodemo-gloriacloud.vercel.app/" },
];
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-6 md:px-12 py-16">
        ...
        <div className="flex justify-center flex-wrap gap-4 mb-12">
           {['All', 'Website Design', 'Web App Development'].map((filter, idx) => (
             <button 
                key={idx}
